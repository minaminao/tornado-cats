...
contract MerkleTreeWithHistory {
    ...
    // filledSubtreesとrootsはbytes32[size]でも良いが、マッピングを使用すればインデックスの範囲のチェックが無くなるのでガスが節約できる
    ...
    /// @dev 2つのリーフをハッシュして MiMC(_left, _right) を返す
    ...
    /// @dev MiMC MerkleツリーのZero（Empty）要素を提供する。最大32レベル。
